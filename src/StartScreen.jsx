...
export default function StartScreen({ onStart }) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4">
      <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg border border-gray-300 overflow-hidden flex flex-col lg:flex-row">
        {/* Imagen */}
        <div className="w-full lg:w-1/2 bg-purple-100 p-6 flex items-center justify-center order-1 lg:order-none">
          <div className="w-full h-64 lg:h-full rounded-lg shadow-lg flex items-center justify-center overflow-hidden">
            <img
              src="./wellness.jpg"
              alt="hola"
        ...
        {/* Formulario */}
        <div className="w-full lg:w-2/3 p-8 order-2">
